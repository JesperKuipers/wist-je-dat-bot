...
{
    public sealed partial class InfoGuildCommand
    {
        /// <summary>
        /// Sends information about the server. Copied from https://github.com/OoLunar/Tomoe/blob/master/src/Commands/Common/InfoCommand/InfoCommand.Guild.cs
        /// </summary>
        ...
        [Command("infoserver"), TextAlias("server", "guild"), Description("Get information about the server.")]
